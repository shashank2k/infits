 ...
 * Use the {@link Section6Q7#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Section6Q7 extends Fragment {
     ...
     * @return A new instance of fragment Section6Q7.
     */
    // TODO: Rename and change types and number of parameters
    public static Section6Q7 newInstance(String param1, String param2) {
        Section6Q7 fragment = new Section6Q7();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_section6_q7, container, false);
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DataSectionSix.veg_other = veg_other;
                DataSectionSix.s6q7 = textView77.getText().toString();
                if (veg_other.equals(""))
                    ...
                    Navigation.findNavController(v).navigate(R.id.action_section6Q7_to_section6Q8);
                }
            }
        });
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ConsultationFragment.psection6>0)
                    ConsultationFragment.psection6-=1;
                Navigation.findNavController(v).navigate(R.id.action_section6Q7_to_section6Q6);
            }
        });
