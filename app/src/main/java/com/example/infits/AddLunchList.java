...
public class AddLunchList extends RecyclerView.Adapter<AddLunchList.AddBreakfastListViewHolder> {
    ...
    public AddLunchList(List<ModelForFood> breakfastList, Context context, AddButtonListenerChart addButtonListenerChart, FoodDetailsListener foodDetailsListener) {
