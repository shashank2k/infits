 ...
 * Use the {@link Section6Q12#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Section6Q12 extends Fragment {
     ...
     * @return A new instance of fragment Section6Q12.
     */
    // TODO: Rename and change types and number of parameters
    public static Section6Q12 newInstance(String param1, String param2) {
        Section6Q12 fragment = new Section6Q12();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_section6_q12, container, false);
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DataSectionSix.fastfood = fastfood;
                DataSectionSix.s6q12 = textView77.getText().toString();
                if (fastfood.equals(""))
                    ...
                    Navigation.findNavController(v).navigate(R.id.action_section6Q12_to_section6Q13);
                }
            }
        });
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ConsultationFragment.psection6>0)
                    ConsultationFragment.psection6-=1;
                Navigation.findNavController(v).navigate(R.id.action_section6Q12_to_section6Q11);
            }
        });
