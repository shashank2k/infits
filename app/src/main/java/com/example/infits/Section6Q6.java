 ...
 * Use the {@link Section6Q6#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Section6Q6 extends Fragment {
     ...
     * @return A new instance of fragment Section6Q6.
     */
    // TODO: Rename and change types and number of parameters
    public static Section6Q6 newInstance(String param1, String param2) {
        Section6Q6 fragment = new Section6Q6();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_section6_q6, container, false);
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DataSectionSix.leafy = leafy;
                DataSectionSix.s6q6 = textView77.getText().toString();
                if (leafy.equals(""))
                    ...
                    Navigation.findNavController(v).navigate(R.id.action_section6Q6_to_section6Q7);
                }
            }
        });
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ConsultationFragment.psection6>0)
                    ConsultationFragment.psection6-=1;
                Navigation.findNavController(v).navigate(R.id.action_section6Q6_to_section6Q5);
            }
        });
