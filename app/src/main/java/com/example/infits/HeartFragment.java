...
public class HeartFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dataSet[0].setColor(Color.parseColor("#E375B3"));
        dataSet[0].setCircleColor(Color.parseColor("#E375B3"));
        ...
        RadioButton week_radioButton = view.findViewById(R.id.week_btn_heart);
        RadioButton month_radioButton = view.findViewById(R.id.month_btn_heart);
        RadioButton year_radioButton = view.findViewById(R.id.year_btn_heart);
        RadioButton custom_radioButton = view.findViewById(R.id.customdates_btn_heart);
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, url, response -> {
                    ...
                    try {
                        ...
                        for (int i = 0; i < cast.length(); i++) {
                            ...
                            String name = actor.getString("avg");
        ...
        month_radioButton.setOnClickListener(v -> {
            NoOfEmp.removeAll(NoOfEmp);
            String url = String.format("%sheartMonthGraph.php", DataFromDatabase.ipConfig);
            StringRequest stringRequest = new StringRequest(Request.Method.POST, url, response -> {
                System.out.println(DataFromDatabase.clientuserID);
                System.out.println(response);
                List<String> allNames = new ArrayList<>();
        ...
        year_radioButton.setOnClickListener(v -> {
            NoOfEmp.removeAll(NoOfEmp);
            String url = String.format("%sheartYearGraph.php", DataFromDatabase.ipConfig);
            StringRequest stringRequest = new StringRequest(Request.Method.POST, url, response -> {
                List<String> allNames = new ArrayList<>();
                JSONObject jsonResponse = null;
                try {
        ...
        custom_radioButton.setOnClickListener(v -> {
            ...
            Button cancel = dialog.findViewById(R.id.cancel);
                ...
                String url = String.format("%scustomHeart.php", DataFromDatabase.ipConfig);
                StringRequest stringRequest = new StringRequest(Request.Method.POST, url, response -> {
                    System.out.println(DataFromDatabase.clientuserID);
                    System.out.println(response);
                    List<String> allNames = new ArrayList<>();
