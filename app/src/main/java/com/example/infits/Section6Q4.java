 ...
 * Use the {@link Section6Q4#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Section6Q4 extends Fragment {
     ...
     * @return A new instance of fragment Section6Q4.
     */
    // TODO: Rename and change types and number of parameters
    public static Section6Q4 newInstance(String param1, String param2) {
        Section6Q4 fragment = new Section6Q4();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_section6_q4, container, false);
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DataSectionSix.milkprod = milkprod;
                DataSectionSix.s6q4 = textView77.getText().toString();
                if (milkprod.equals(""))
                    ...
                    Navigation.findNavController(v).navigate(R.id.action_section6Q4_to_section6Q5);
                }
            }
        });
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ConsultationFragment.psection6>0)
                    ConsultationFragment.psection6-=1;
                Navigation.findNavController(v).navigate(R.id.action_section6Q4_to_section6Q3);
            }
        });
