 ...
 * Use the {@link Section6Q10#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Section6Q10 extends Fragment {
     ...
     * @return A new instance of fragment Section6Q10.
     */
    // TODO: Rename and change types and number of parameters
    public static Section6Q10 newInstance(String param1, String param2) {
        Section6Q10 fragment = new Section6Q10();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_section6_q10, container, false);
        ...
        thrWeek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dry_fruits="3-4 times in a week";
            }
        });
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DataSectionSix.dry_fruits = dry_fruits;
                DataSectionSix.s6q10 = textView77.getText().toString();
                if (dry_fruits.equals(""))
                    ...
                    Navigation.findNavController(v).navigate(R.id.action_section6Q10_to_section6Q11);
                }
            }
        });
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ConsultationFragment.psection6>0)
                    ConsultationFragment.psection6-=1;
                Navigation.findNavController(v).navigate(R.id.action_section6Q10_to_section6Q9);
            }
        });
