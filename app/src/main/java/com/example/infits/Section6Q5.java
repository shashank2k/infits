 ...
 * Use the {@link Section6Q5#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Section6Q5 extends Fragment {
     ...
     * @return A new instance of fragment Section6Q5.
     */
    // TODO: Rename and change types and number of parameters
    public static Section6Q5 newInstance(String param1, String param2) {
        Section6Q5 fragment = new Section6Q5();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_section6_q5, container, false);
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DataSectionSix.roots = roots;
                DataSectionSix.s6q5 = textView77.getText().toString();
                if (roots.equals(""))
                    ...
                    Navigation.findNavController(v).navigate(R.id.action_section6Q5_to_section6Q6);
                }
            }
        });
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ConsultationFragment.psection6>0)
                    ConsultationFragment.psection6-=1;
                Navigation.findNavController(v).navigate(R.id.action_section6Q5_to_section6Q4);
            }
        });
