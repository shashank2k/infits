...
public class AddSnackList extends RecyclerView.Adapter<AddSnackList.AddBreakfastListViewHolder> {
    ...
    public AddSnackList(List<ModelForFood> breakfastList, Context context, AddButtonListenerChart addButtonListenerChart, FoodDetailsListener foodDetailsListener) {
