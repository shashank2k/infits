 ...
 * Use the {@link Section3Q4#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Section3Q4 extends Fragment {

    ImageButton imgBack;
    Button nextbtn;
    TextView backbtn, diatv;
     ...
     * @return A new instance of fragment Section3Q4.
     */
    // TODO: Rename and change types and number of parameters
    public static Section3Q4 newInstance(String param1, String param2) {
        Section3Q4 fragment = new Section3Q4();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_section3_q4, container, false);
        ...
        diatv = view.findViewById(R.id.textView77);
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DataSectionThree.nausea = nausea;
                DataSectionThree.s3q4 = diatv.getText().toString();
                if (nausea.equals(""))
                    ...
                    Navigation.findNavController(v).navigate(R.id.action_section3Q4_to_section3Q5);
                }
            }
        });
