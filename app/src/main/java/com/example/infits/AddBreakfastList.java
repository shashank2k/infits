...
public class AddBreakfastList  extends RecyclerView.Adapter<AddBreakfastList.AddBreakfastListViewHolder> {
    ...
    public AddBreakfastList(List<ModelForFood> breakfastList, Context context, AddButtonListenerChart addButtonListenerChart, FoodDetailsListener foodDetailsListener) {
