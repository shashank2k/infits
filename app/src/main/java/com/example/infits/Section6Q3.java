 ...
 * Use the {@link Section6Q3#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Section6Q3 extends Fragment {
     ...
     * @return A new instance of fragment Section6Q3.
     */
    // TODO: Rename and change types and number of parameters
    public static Section6Q3 newInstance(String param1, String param2) {
        Section6Q3 fragment = new Section6Q3();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_section6_q3, container, false);
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DataSectionSix.milk = milk;
                DataSectionSix.s6q3 = textView77.getText().toString();
                if (milk.equals(""))
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ConsultationFragment.psection6>0)
                    ConsultationFragment.psection6-=1;
                Navigation.findNavController(v).navigate(R.id.action_section6Q3_to_section6Q2);
            }
        });
